...
namespace WoodenPong
{
    public class Button
    {
        ...
        public Button(Pong game,Vector2 pos, int width, int height, string text, Action a)
        {
            _game = game;
            _opacity = 0.7f;
            _position = pos;
        ...
        public Button(Pong game, Vector2 pos, int width, int height, string text, ref string textvar, Action a)
        {
            _game = game;
            _opacity = 0.7f;
            _position = pos;
        ...
        public void Update(GameTime gt)
        {
            ...
            if (
                Mouse.GetState().Position.X >= _position.X
                && Mouse.GetState().Position.X <= _position.X + _width

...
namespace WoodenPong
{
    ...
    public class Pong : Game
    {
        ...
        protected string _gameStateTitle { get; set; }
        ...
        protected override void LoadContent()
        {
            ...
            BallHitLeft = Content.Load<SoundEffect>("SOUNDS/ping_left");
            BallHitRight = Content.Load<SoundEffect>("SOUNDS/ping_right");
            BallHitUpDown = Content.Load<SoundEffect>("SOUNDS/ping");

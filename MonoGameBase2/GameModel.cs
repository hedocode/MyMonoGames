...
namespace GameBaseArilox
{
    public abstract class GameModel : Game
    {
        ...
        protected ButtonDrawer ButtonDrawer;
        ...
        protected ButtonUpdater ButtonUpdater;
        ...
        // MultipleGames
        protected List<GameModel> games = new List<GameModel>();
        protected int currentGameIndex = 0;
        ...
        protected GameModel()
        {
            ...
            ButtonUpdater = new ButtonUpdater(this);
            Cursor = new Cursor("Cursor2");
            ShapeDrawer = new ShapeDrawer(this);
            ButtonDrawer = new ButtonDrawer(this);
